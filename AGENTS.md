...
preloader → hero（大标题 + 泡泡场）→ PHOTOGRAPHY（横向拖拽画廊 11 帧）→ GAME ARCHIVE（HOF 7 卡）→ TICKER（收藏计数条）→ THE ARCHIVE（书 6 / 影 16 / 剧 19 / 音乐 763 首 16 组 / 球队 5，五 tab）→ TICKER（DO NOT GO GENTLE）→ POEM → ABOUT（签名 + 统计）→ footer。
